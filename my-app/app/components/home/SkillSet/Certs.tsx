                        ...
                        <div className="lg:mb-0">
                            <div
                                ...
                                <div className="flex justify-center">
                                    <div className="-mt-6 inline-block rounded-full bg-white p-4 text-accent shadow-md">
                                ...
                                <div className="p-6">
                                    <h3 className="mb-4 text-l md:text-xl font-bold text-primary">
                                        Certified Application Developer
                                    </h3>
                                    <h5 className="mb-4 text-base text-secondary font-medium ">ServiceNow, 23711164</h5>
                                </div>
                            </div>
                        </div>
                        {/* SYS ADMIN */}
                        <div className="lg:mb-0">
                            <div
                                ...
                                <div className="p-6">
                                    ...
                                    <h5 className="mb-4 text-base text-secondary font-medium">ServiceNow, ID 23604081</h5>
                                </div>
                            </div>
                        </div>
                        {/* ITSM SPECIALIST */}
                        <div className="lg:mb-0">
                            <div
                                ...
                                <div className="p-6">
                                    ...
                                    <h5 className="mb-4 text-base text-secondary font-medium">ServiceNow, Able to obtain</h5>
                                </div>
                            </div>
                        </div>
